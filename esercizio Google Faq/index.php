<?php
    $myArray = [
        ...
        [
            ...
            "testo" => "Il tuo account è associato a un paese (o territorio) nei Termini di servizio per poter stabilire due cose:
...
<body>
    ...
    <?php
        foreach($myArray as $faq => $singolaFaq) {
            echo "<h1>" . $singolaFaq["titolo"] . "</h1>" . "<p>" . $singolaFaq["testo"] . "</p>";
        }
    ?>
